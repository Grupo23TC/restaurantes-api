package com.fiap.tc.restaurantes.application.core.domain.enumeration;
...
public enum EstadoEnum {
    ...
    SANTA_CATARINA("Santa Catarina", "SC", "Florianópolis"), PARAIBA("Paraíba", "PB", "João PessoaEntity"),
    ...
    private static final Map<String, EstadoEnum> SIGLA_ESTADO_MAP = Arrays.stream(EstadoEnum.values())
            .collect(Collectors.toMap(e -> e.sigla, e -> e));
    ...
    public static EstadoEnum getEnum(String sigla) {
        ...
        if (!SIGLA_ESTADO_MAP.containsKey(s))
            return null;
